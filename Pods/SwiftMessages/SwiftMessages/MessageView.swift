...
public extension MessageView {
     ...
     */
    static func viewFromNib<T: MessageView>(layout: Layout, filesOwner _: AnyObject = NSNull()) -> T {
    ...
    /**
     ...
     - Returns: An instance of generic view type `T: MessageView`.
     */
    static func viewFromNib<T: MessageView>(layout: Layout, bundle: Bundle, filesOwner: AnyObject = NSNull()) -> T {
...
public extension MessageView {
     ...
     */
    func configureIcon(withSize size: CGSize, contentMode: UIView.ContentMode? = nil) {
        var views: [UIView] = []
...
public extension MessageView {
     ...
     */
    func configureTheme(_ theme: Theme, iconStyle: IconStyle = .default) {
     ...
     */
    func configureTheme(backgroundColor: UIColor, foregroundColor: UIColor, iconImage: UIImage? = nil, iconText: String? = nil) {
...
public extension MessageView {
     ...
     */
    func configureContent(body: String) {
        bodyLabel?.text = body
    }
     ...
     */
    func configureContent(title: String, body: String, iconImage: UIImage) {
     ...
     */
    func configureContent(title: String, body: String, iconText: String) {
        configureContent(title: title, body: body)
        iconLabel?.text = iconText
     ...
     */
    func configureContent(title: String?, body: String?, iconImage: UIImage?, iconText: String?, buttonImage: UIImage?, buttonTitle: String?, buttonTapHandler: ((_ button: UIButton) -> Void)?) {
        titleLabel?.text = title
        bodyLabel?.text = body
        iconImageView?.image = iconImage
        iconLabel?.text = iconText
