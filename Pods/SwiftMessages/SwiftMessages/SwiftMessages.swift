...
public extension SwiftMessages {
     ...
     */
    func current<T: UIView>(id: String) -> T? {
        var view: T?
        messageQueue.sync {
     ...
     */
    func queued<T: UIView>(id: String) -> T? {
        var view: T?
        messageQueue.sync {
    ...
    /**
     ...
     - Returns: The view with matching id if currently queued to be shown.
     */
    func currentOrQueued<T: UIView>(id: String) -> T? {
...
public extension SwiftMessages {
     ...
     */
    class func viewFromNib<T: UIView>(_ filesOwner: AnyObject = NSNull()) throws -> T {
    ...
    /**
     ...
     - Returns: An instance of generic view type `T`.
     */
    class func viewFromNib<T: UIView>(named name: String, filesOwner: AnyObject = NSNull()) throws -> T {
        let view: T = try internalViewFromNib(named: name, bundle: nil, filesOwner: filesOwner)
        return view
    }
    ...
    /**
     ...
     - Returns: An instance of generic view type `T`.
     */
    class func viewFromNib<T: UIView>(named name: String, bundle: Bundle, filesOwner: AnyObject = NSNull()) throws -> T {
...
public extension SwiftMessages {
     ...
     */
    static var sharedInstance: SwiftMessages {
        return globalInstance
    }

    static func show(viewProvider: @escaping ViewProvider) {
        globalInstance.show(viewProvider: viewProvider)
    }

    static func show(config: Config, viewProvider: @escaping ViewProvider) {
    ...
    static func show(config: Config, view: UIView) {
    ...
    static func hideCounted(id: String) {
    ...
    static var pauseBetweenMessages: TimeInterval {
        get {
    ...
    static func current<T: UIView>(id: String) -> T? {
        return globalInstance.current(id: id)
    }

    static func queued<T: UIView>(id: String) -> T? {
        return globalInstance.queued(id: id)
    }

    static func currentOrQueued<T: UIView>(id: String) -> T? {
    ...
    static func set(count: Int, for id: String) {
